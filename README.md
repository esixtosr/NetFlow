...
[![Live Demo](https://img.shields.io/badge/Live_Demo-Click_Here-blue?style=for-the-badge)](https://esixtosr.github.io/NetFlow/)
...
![NetFlow App Demo](drop-your-video-or-gif-link-here)
...
![VLAN Segmentation Example](drop-your-image-link-here)
...
Because NetFlow relies entirely on vanilla web technologies, there are no package managers (like `npm`) or backend servers required. 

**Option 1: Quick Run**
1. Clone the repository: `git clone https://github.com/esixtosr/NetFlow.git`
2. Navigate into the directory: `cd NetFlow`
...
If you plan to modify the code, running a local HTTP server prevents browser CORS restrictions when exporting media:
1. Open the project folder inside **Visual Studio Code**.
2. Install the **Live Server** extension by Ritwick Dey.
3. Right-click on `index.html` and select **Open with Live Server**.
4. The application will launch locally at `http://127.0.0.1:5500/index.html`.
